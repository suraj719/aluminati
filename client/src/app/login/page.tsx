...
export default function page() {
  ...
  return (
    <>
      <div className="bg-gray-900 w-full h-[91vh] text-white flex flex-col items-center justify-center px-4">
        <div className="max-w-sm w-full  space-y-5">
          ...
          <button className="w-full flex items-center justify-center gap-x-3 py-2.5 border rounded-lg text-sm font-medium hover:bg-gray-800 duration-150">
            <svg
              className="w-5 h-5"
              viewBox="0 0 48 48"
              fill="none"
